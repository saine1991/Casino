...
public class ApplicationInitializer implements WebApplicationInitializer {
	...
	public void onStartup(ServletContext servletContext) throws ServletException {
		...
		servletRegistration.setLoadOnStartup(1); // 1 - priorytet ze chcemy aby
													// apka serwera
													// zainicjalizowala jaka
													// pierwsza ta aplikacje
		servletRegistration.addMapping("/"); // okreslamy poczatek mapowania w
												// url

		CharacterEncodingFilter characterEncodingFilter = new CharacterEncodingFilter();
		characterEncodingFilter.setEncoding("UTF-8");
		characterEncodingFilter.setForceEncoding(true); // do nadpisywania
														// innego kodowania w
														// requestach
